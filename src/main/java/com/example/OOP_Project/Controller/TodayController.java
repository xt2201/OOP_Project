...
public class TodayController {
    String[][] inputs = {
            {"Title 1", "Type 1", "News 1", "Summary 1", "Category 1", "Tag 1", "Time 1", "https://www.facebook.com/", "https://www.w3schools.com/images/w3schools_logo_436_2.png"},
...
public void addArticles() {
    ...
    for (int i = 0; i < inputs.length; i++) {
        ...
        AnchorPane art = article.createArticle(inputs[i][0], inputs[i][1], inputs[i][2], inputs[i][3],inputs[i][4]);
        ...
        moreButton.setOnAction(event -> {
            ...
            setPane(inputs[finalI][0], inputs[finalI][1], inputs[finalI][2], inputs[finalI][3], inputs[finalI][4], inputs[finalI][5], inputs[finalI][6], inputs[finalI][7],inputs[finalI][8]);
        });
    ...
    public void addreadlater() {
        ...
        for (Article article : articles) {
            if (article.getPane() == true) {
                AnchorPane art = article.getAnchorPane(inputs[i][0], inputs[i][1], inputs[i][2], inputs[i][3], inputs[i][4]);
